 ...
 */
 ...
 function myFunction() {
   ...
   for (var i = 1; i < HOJAS + 1; i++) {
     ...
     //console.log(valoresTel)
 
     // Obtener valores de columna de telefonos en la hoja i
     //let telefonos = doc1.getRange(i +"!" + SELECCION_TELEFONOS).getValues();
 
     // Limpiar array de telefonos para poder iterarlos
     telefonos = limpiarArray(telefonos)
 
     // Limpiar array de personas para poder iterarlos en la hoja i
     //let personas = doc1.getRange(i +"!" + SELECCION_PERSONAS).getValues();
   ...
   /* 
   * Puntos siguientes
     Expandir para que tome todas las hojas del Google Sheet
     Expandir para que lea todos los Sheets de una carpeta
    */
